        ...
        <div className="container mx-auto">
          ...
          <div className="flex items-center justify-between py-3 px-4 lg:py-4 lg:px-0">
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              ...
              <Link 
                to="/account" 
                className="hidden md:flex text-[#333333] hover:text-[#6B8E23] transition-colors relative"
              >
                <FaUser size={24} className="lg:w-6 lg:h-6" />
              </Link>
          ...
          <div className={`lg:hidden bg-white border-t border-[#E5E5E5] transition-all duration-300 ease-in-out overflow-hidden ${
            ...
            <div className="container mx-auto py-4 px-4 space-y-4">
              ...
              <Link
                ...
                className="flex items-center space-x-3 p-4 rounded-2xl bg-[#F5F5DC] text-[#333333] font-bold hover:bg-[#6B8E23] hover:text-white transition-colors"
              >
                <FaUser size={20} />
              ...
              <div className="space-y-2">
                {[
                  ...
                  <Link
                    ...
                    to={item.path}
                    onClick={() => setOpen(false)}
                    className="flex items-center space-x-3 py-4 px-4 rounded-2xl bg-[#F5F5DC] text-[#333333] font-bold hover:bg-[#6B8E23] hover:text-white transition-colors text-sm"
                  >
              ...
              <button 
                ...
                className="w-full bg-[#DC143C] text-white py-4 rounded-2xl font-bold hover:bg-[#C1121F] transition-colors text-sm shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
              >
                🚀 REQUEST PRODUCTS
              </button>
